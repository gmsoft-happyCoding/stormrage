...
const config = require(configResolve('webpack.config.dev'));
const createDevServerConfig = require(configResolve('webpackDevServer.config'));
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    devServer.listen(port, HOST, err => {
      ...
      // DEV_BUILD mode not openBrowser
      !DEV_BUILD && openBrowser(urls.localUrlForBrowser);
    });
